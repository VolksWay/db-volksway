...
VALUES (UUID_TO_BIN(UUID()), UUID_TO_BIN("cada5c90-8986-11ee-bce7-b445067b827e"), "Viviane", "(11) 1111-11111", "adm@gmail.com", "124", "2004-08-16", "Sao Paulo", "111.111.111-11", "teste", 0);
...
VALUES (UUID_TO_BIN(UUID()), UUID_TO_BIN("dcd225f5-8986-11ee-bce7-b445067b827e"), "Volkswagen", "111-1111", "11111-11111-11111-11");

SELECT BIN_TO_UUID(id_veiculo), BIN_TO_UUID(id_usuario), marca, placa, codigo_chassi FROM tb_veiculo;

#CHECKLIST
INSERT INTO tb_checklist
VALUES (UUID_TO_BIN(UUID()), UUID_TO_BIN("f03b2ddd-8986-11ee-bce7-b445067b827e"), true, false, true, false, "url da foto");
...
VALUES (UUID_TO_BIN(UUID()), UUID_TO_BIN("dcd225f5-8986-11ee-bce7-b445067b827e"), "Parceira da Volks vende pneu barato!", "https://volksway", "Venha comprar o seu pneu!", "https://volksway/img", "Todos", "2023-11-23", 1000, true, "Banner");
...
VALUES (UUID_TO_BIN(UUID()), UUID_TO_BIN("24b98f33-8987-11ee-bce7-b445067b827e"), UUID_TO_BIN("dcd225f5-8986-11ee-bce7-b445067b827e"), true);
